...
✅ Update to new camelCase method names (e.g., SendBulk → sendBulk)
✅ Add TypeScript for better IDE support
✅ Consider using the functional smsBuilder API for cleaner code
⚠️ Old PascalCase methods will be removed in v3.0.0
Requirements
...
Follow the existing code style (TypeScript, JSDoc comments, etc.)
